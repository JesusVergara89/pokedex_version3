  ...
  return (
    <main className="pokedex">
        <section className="pokedex__header">
            <p className="pokedex__text"><span>Welcome {trainerName}, </span>Catch them all!</p>
            <form className="pokedex__form">
                <article className="pokedex__searcher">
                    <input type="text" placeholder="Find ur pokemón!" value={filterName} onChange={handleFilterName}/>
                </article>
